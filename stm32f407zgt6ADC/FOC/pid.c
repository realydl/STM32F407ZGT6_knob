...
//	PID_velocity.I=0.9;    //10
	...
	//电流环q轴PID
	//GB6010
//	PID_current_q.P=3;  //航模电机，速度闭环，不能大于1，否则容易失控0.5
//	PID_current_q.I=300;   //电流环I参数不太好调试，只用P参数也可以3 
...
//	PID_current_q.I=300;    //电流环I参数不太好调试，只用P参数也可以
	...
	PID_current_q2.P=0.5;  //航模电机，速度闭环，不能大于1，否则容易失控
	PID_current_q2.I=3;    //电流环I参数不太好调试，只用P参数也可以
...
//	PID_current_d.I=300;  //0.5
	...
	PID_current_d2.P=0.5;  //航模电机，速度闭环，不能大于1，否则容易失控
	PID_current_d2.I=3;    //电流环I参数不太好调试，只用P参数也可以
